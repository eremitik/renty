  ...
  return (
    <Card className={classes.card} onClick={handleClick}>
      ...
      <div className={classes.detailsTwo}>
        ...
        <Typography className={classes.metadata} variant="body2" color="textSecondary" component="p">total paid: ¥{Intl.NumberFormat().format(orderedItem.totalPrice)}</Typography>
